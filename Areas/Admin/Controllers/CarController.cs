...
namespace Car_Project.Areas.Admin.Controllers
{
    ...
    public class CarController : Controller
    {
        ...
        public CarController(ApplicationDbContext db, IFileService fileService)
        {
            _db = db;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var cars = await _db.Cars.Include(c => c.Brand).Include(c => c.Images)
